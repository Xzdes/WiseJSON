...
// ... (sendJson, sendError, checkAuth, serveStaticFile без изменений) ...
...
async function requestHandler(req, res) {
    ...
    if (collectionRouteMatch && method === 'GET') {
        ...
        // ИСПРАВЛЕНИЕ: Используем parseFilterFromQuery
    ...
    // ... (остальные роуты, такие как /stats, /doc, /indexes, остаются без изменений) ...
    // Они уже были в порядке.
